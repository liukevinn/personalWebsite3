  ...
  return (
    <div className="app-container">
      <div className="profile-header">
        ...
        <h1 className="h1" >hey,&nbsp;&nbsp;i'm kevin.</h1>
        <button className="back-to-top" onClick={scrollToMiddle}>learn more about me!</button>
      </div>
      
      
      {/* Dropdown navigation */}
      <Dropdown />
      <h1 className='header' id="getToKnowMe">Get to know me!</h1>
